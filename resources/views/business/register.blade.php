...
@section('content')
    ...
    <div class="col-md-8 col-sm-10 col-xs-12 col-md-offset-2 col-sm-offset-1 tw-mt-2 md:tw-mt-6 tw-px-2 md:tw-px-0">
        <div
            class="tw-p-3 md:tw-p-4 tw-mb-4 tw-transition-all tw-duration-200 tw-bg-white tw-shadow-sm tw-rounded-xl tw-ring-1 tw-ring-gray-200 tw-w-full tw-max-w-4xl tw-mx-auto">
            <div class="tw-flex tw-flex-col tw-gap-4 tw-p-2 md:tw-p-6">
                <div class="tw-flex tw-flex-col tw-p-2 md:tw-p-6 text-center">
